...
- 核心理由: [一段话]"""
        ...
        print(f"    投票: {vote} ({vote_bps:+d}bps)")
        return result
...
4. 保持正式、精确、中性的官方沟通口吻"""
    ...
    def run(
        ...
        print(f"\n{'='*60}")
        print(f"  🏛️  FedSight AI - FOMC 模拟开始")
